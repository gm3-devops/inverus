  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        input: "hsl(var(--input))",
        ring: "hsl(var(--ring))",
        particles: "hsl(var(--particles-bg))",
      ...
      keyframes: {
        ...
        glow: {
          "0%, 100%": {
            filter:
              "drop-shadow(0 0 10px rgba(96, 165, 250, 0.8)) drop-shadow(0 0 20px rgba(96, 165, 250, 0.6))",
          },
          "50%": {
            filter:
              "drop-shadow(0 0 15px rgba(96, 165, 250, 1)) drop-shadow(0 0 25px rgba(96, 165, 250, 0.8))",
          },
        },
        spotlight: {
