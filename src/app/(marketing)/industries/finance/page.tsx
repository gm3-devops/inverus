...
import { finance, finsolutions } from "@/constants/industries";
...
const FINANCECASE = [
    {
        ...
        description:
            "Validate identities before account creation..",
        href: "/",
        cta: "Learn more",
    ...
    },
    {
        ...
        name: "Loan Approvals",
        description:
            "Detect fraudulent loan applications early.",
        href: "/",
        cta: "Learn more",
    ...
    },
    {
        ...
        description: "Real-time risk detection across banking activities.",
