export const leadershipTeam = [
  {
    ...
    description: [
      ...
      "Solutions Architect and Innovator at Spotify (2011-2014).",
      ...
      "Pioneer in IP, data security and innovative problem solving.",
...
export const teamMembers = [
  ...
  },
  {
    ...
    description: [
      "VP – Strategic Transactions at GE Capital",
